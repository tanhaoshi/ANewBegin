package com.example.administrator.myapplication.Sqlite3Package;
...
/**
 * Created by tanhaoshi on 2016/12/12.
 * sqlite3 Uitle
 */
...
public class DataBaseOpenHelper extends SQLiteOpenHelper{
    ...
    public DataBaseOpenHelper(Context mcontext ,String dbName ,int dbVersion, List<String> tableSqls){
    ...
    public static DataBaseOpenHelper getInstance(Context mcontext,String dbName,int dbVersion,List<String> tableSqls){
       DataBaseOpenHelper mDataBaseOpenHelper = dbMaps.get(dbName);
        if(mDataBaseOpenHelper == null){
            mDataBaseOpenHelper = new DataBaseOpenHelper(mcontext,dbName,dbVersion,tableSqls);
        }
        dbMaps.put(dbName, mDataBaseOpenHelper);
